...
/* 	$("#insert").on("blur",".etotal",function(){
	...
	$("#expend").click(function(){
		$("#frm").prepend('<p class="insertt" id="exp'+j+'"><input type="text" class="storename" name="store" value="${store}" readonly="readonly"><input type="text" class="kind" name="kind"><input type="number" name="expend" id="price" class="etotal imoney insertmoney"><input type="hidden" name="pos_import" id="price" value="0"><span id="'+j+'" class="X">X</span></p>');
	j++;
	});
...
<div id="postitle"><ul><li class="storename">가게명</li><li class="kind">종류</li><li class="imoney">가격</li></ul></div>
<div id="insert"></div>
